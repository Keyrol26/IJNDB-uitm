                    ...
                    <div class="card-body">
                        ...
                        <div class='dataTable-search' class="pull-left">
                            <form class="search-form d-flex" method="get">
                                ...
                                &nbsp;
                                <button type="reset" class="btn btn-danger"><a href="/home" style="color: white">Clear
                                        Filter</a></button>
                            </form>
                            <br>
                            <div class="col-md-12 col-md-offset-1">
                                <h2>
                                    <button type="button" id="click-me" data-bs-toggle="modal" data-bs-target="#addnew"
                                        class="btn btn-info pull-right" style="float:right;margin:5px;"><i
                        ...
                        <table class="table table-hover" id="patienttable" style="width:100%">
                            <thead>
                                <tr>
