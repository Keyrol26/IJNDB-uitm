<div class="modal-body">
    <div class="container" style="border-style: inset; padding: 20px;">
        {{-- <div class="container rounded" style="background-color: rgb(185, 224, 224)"> --}}
        {{-- <br> --}}
        {{-- <div class="row">
            <div class="col">MRN</div>
        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-2">{{ $labresult[0]->order_date }}</div>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($labresult as $item)
                        @if ($item->test_set == $data->test_set)
                            <tr>
